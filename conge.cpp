...
Conge::Conge(QString loginemploye,QString typeConge,QString commentaireResponsable, QString CommentaireEmploye, QString DateDebutConge,QString DateFinConge)
{
...
bool Conge::RechercherConge(QString IdCongeUtilisateur){
QSqlQuery query;
