...
**
** Created: Fri 18. Sep 17:31:22 2015
...
static const char qt_meta_stringdata_Statistiques[] = {
    "Statistiques\0"
};
...
const QMetaObjectExtraData Statistiques::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Statistiques::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Statistiques,
      qt_meta_data_Statistiques, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Statistiques::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Statistiques))
